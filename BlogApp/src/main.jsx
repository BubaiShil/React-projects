...
import LoginComponenets from "./Pages/Login.jsx"
...
const router = createBrowserRouter(
  createRoutesFromElements(
    ...
    <Route path='/login' element={<AuthLayout authentication={false}><LoginComponenets/></AuthLayout>}/>
    <Route path='/signup' element={<AuthLayout authentication={false}><SignUpComponent/></AuthLayout>}/>
