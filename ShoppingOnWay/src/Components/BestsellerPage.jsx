...
const BestsellerPage = ({ name, company, image, id ,price}) => {
    ...
    const handleQuantityChange = (e) => {
        ...
        if (value > 0) {
            setQuantity(value); // Update the quantity based on user input
        }
    };
  ...
  return (
    <div className='w-64 h-[30rem] bg-white rounded-lg shadow-2xl p-4 flex flex-col items-center'>
      ...
      <div className='flex items-center gap-2 p-4 font-extrabold text-md rounded-xl text-white mt-9 cursor-pointer bg-black' onClick={() => addToCart(id,quantity)}>
