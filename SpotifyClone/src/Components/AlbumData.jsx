...
const AlbumData = () => {
    ...
    return (
        <>
            <Navbar />
            <div className='lg:flex lg:flex-row gap-4 mt-12 sm:flex-col'>
                ...
                {songsData.map((e,index) => (
                    <div key={index} className='grid grid-cols-3 lg:grid-cols-4 gap-3 p-3 mt-5 items-center text-[#a7a7a7] rounded-md hover:bg-[#ffffff2b]  cursor-pointer'>
                        <p>{index+1}</p>
